...
const galleryImages = [
    { id: 1, src: '/gallery/balcony/1.jpeg' },
    { id: 2, src: '/gallery/balcony/2.jpeg' },
];
        ...
        <div className="min-h-screen bg-[var(--background)] py-20 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden shadow-xl mb-12">
                    <Image
                        src="/gallery/balcony/cover.jpeg"
                        alt="מרפסת פנורמית ופינת רביצה"
                        fill
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent flex flex-col justify-end p-8 md:p-12 text-right">
                        <h1 className="text-4xl md:text-6xl font-black text-white mb-2">מרפסת פנורמית ופינת רביצה</h1>
                        <p className="text-xl md:text-2xl text-[var(--accent)] font-bold">עיצוב מרחב חיצוני</p>
                    </div>
                </div>
                ...
                <div className="max-w-3xl mx-auto text-center mb-16">
                    <p className="text-lg md:text-xl leading-relaxed text-[var(--foreground)]/80">
                        עיצוב מרפסת פנורמית עם פינת רביצה מזמינה – שילוב של נוחות מקסימלית עם נוף פתוח. החלל תוכנן ליצור פינת מנוחה אינטימית באוויר הפתוח.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {galleryImages.map((img) => (
                        ...
                        >
                            <Image
                                src={img.src}
                                alt={`מרפסת פנורמית - תמונה ${img.id}`}
                                fill
