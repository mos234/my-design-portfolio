...
export default function VacationApartmentPage() {
    return (
        <ProjectGallery
            ...
            description="בית נופש משפחתי הצופה על אגם הכנרת. רצינו להכניס את הנוף לחלל המרכזי, כך שגם תוך הכנת המזון ובישול, האי צופה לכיוון אגם הכנרת והופך להיות חלק בלתי נפרד מחלל הבית. שמרנו על קו עיצוב התואם את אווירת הסביבה ובלתי מנותק. במטבח הייחודי בצבע ג'ינס שמתמזג עם המים התכולים המשתקפים פנימה."
            images={images}
        />
    );
}
