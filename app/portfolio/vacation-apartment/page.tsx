...
const galleryImages = [
    { id: 1, src: '/gallery/vacation-apartment/1.jpeg' },
    { id: 2, src: '/gallery/vacation-apartment/2.jpeg' },
    { id: 3, src: '/gallery/vacation-apartment/3.jpeg' },
];
        ...
        <div className="min-h-screen bg-[var(--background)] py-20 px-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden shadow-xl mb-12">
                    <Image
                        src="/gallery/vacation-apartment/cover.jpeg"
                        alt="עיצוב ותכנון דירת נופש"
                        fill
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent flex flex-col justify-end p-8 md:p-12 text-right">
                        <h1 className="text-4xl md:text-6xl font-black text-white mb-2">דירת נופש</h1>
                        <p className="text-xl md:text-2xl text-[var(--accent)] font-bold">עיצוב ותכנון</p>
                    </div>
                </div>
                ...
                <div className="max-w-3xl mx-auto text-center mb-16">
                    <p className="text-lg md:text-xl leading-relaxed text-[var(--foreground)]/80">
                        עיצוב ותכנון דירת נופש – יצירת חלל מזמין ונעים שמשלב פונקציונליות עם אסתטיקה. העיצוב מדגיש תחושת חופש ונוחות לאורחים.
                    </p>
                </div>
