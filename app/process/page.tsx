...
const faqItems = [
    {
        ...
        answer: "עלות עיצוב פנים תלויה בגודל הנכס והיקף השירות. לאחר התרשמות בנכס ובצרכים הנדרשים תונפק הצעת מחיר מפורטת.",
    },
    {
        question: "כמה זמן לוקח פרויקט עיצוב פנים מלא?",
        answer: "משך זמן הפרויקט תלוי בהיקף העבודה ובמורכבות שלה. הריסה - בניה, נגרות וכו', אך בהחלט ייקח כמה חודשים.",
    },
    {
    ...
    },
    {
        ...
        answer: "כן. סטודיו AZ Designs מתמחה גם בעיצוב חללים מסחריים: בתי קפה, מסעדות, מאפיות, חנויות ועסקים קטנים. יש לנו ניסיון רחב בסגנונות שונים ובהתאמת העיצוב לטרנד ולקהל היעד של העסק.",
    },
    {
