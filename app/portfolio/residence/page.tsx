...
export default function ResidenceProjectPage() {
    return (
        <ProjectGallery
            ...
            description="האתגר המשמעותי היה ליצור יחידת הורים במצב שטח וללא תשתיות מתאימות. שטח מצומצם, תשתיות ביוב ומים, והסתרת עמודי בנין (תמך) – וזאת תוך כדי מגורים בדירה תחת העבודה והביצוע. יצרנו יחידת הורים פונקציונלית ומושלמת, אזור מזנון יינות ומשקאות חריפים, פינת אוכל ייעודית, ושדרוג הסלון לסגנון קלאסי חם ומזמין."
            images={images}
        />
    );
}
