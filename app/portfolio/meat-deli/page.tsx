...
export default function MeatDeliPage() {
    return (
        <ProjectGallery
            ...
            description="החנות ממוקמת על קו הרחוב. בובידלנו את הצבעים מכל המתרחש סביב על מנת ליצור קו ייחודי שבולט מעל המתרחש סביב, תוך הנגשה מירבית, סביבת עבודה נוחה ופונקציונלית."
            images={images}
        />
    );
}
