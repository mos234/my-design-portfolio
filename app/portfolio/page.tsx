...
const portfolioFaqItems = [
    ...
    },
    {
        ...
        answer: "פרויקט מסחרי כמו בית קפה או מאפייה נמשך בדרך כלל בין 3-6 חודשים, תלוי בגודל ובהיקף. זה כולל תכנון, בחירת חומרים, עבודה מול קבלנים ופיקוח.",
    },
    {
        question: "האם ניתן לעצב עם תקציב מוגבל?",
        answer: "כן. בסטודיו AZ Designs מאמינים שעיצוב מקצועי אינו חייב להיות יקר. נתאים את הפתרון לתקציב שלכם תוך שמירה על סטנדרט מקצועי גבוה. כל הצעת מחיר ניתנת בשקיפות מלאה. אך על הלקוח לקחת בחשבון שתקציב נמוך בדרך כלל יהיה כרוך בהתפשרות על פונקציות מסויימות וחומרים.",
    },
    {
    ...
    },
    {
        ...
        answer: "בחלל מסחרי הדגש הוא על חוויית לקוח, זרימת תנועה, טרנד! ועמידות חומרים. בחלל מסחרי צריך לקחת בחשבון תכנון מערכות מורכבות, כגון תקנים של כבאות, רישוי עסקים, נגרות וכו. בחלל פרטי הדגש הוא על אישיות, נוחות ואווירה ביתית. סטודיו AZ Designs בקיא בשני הסוגים ומביא ניסיון ייחודי מכל עולם.",
    },
];
