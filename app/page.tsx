...
const homeFaqItems = [
    ...
    },
    {
        ...
        answer: "סטודיו AZ Designs פועל בעיקר בירושלים וסביבותיה.",
    },
    {
        question: "כיצד מתחילים תהליך עיצוב פנים עם AZ Designs?",
        answer: "מתחילים בשיחת טלפון לפרטים ראשוניים כדי להבין את הצרכים וההיקף, וננפיק הצעת מחיר. לחצו על צור קשר. ובהצלחה",
    },
    {
    ...
    },
    {
        ...
        answer: "לא. שיחת ההיכרות לא כרוכה בתשלום ולא מחייבת כלל.",
    },
];
    ...
    <div className="min-h-screen flex flex-col font-sans overflow-x-hidden">
      ...
      <section className="py-20 px-4 border-t border-[var(--foreground)]/5 backdrop-blur-sm bg-[var(--background)]/80">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-3xl md:text-4xl font-black text-[var(--accent)]">נעים להכיר, אני אבי</h2>
